...
type: post
published: true
title: Flexible oneline/multiline formatting
summary: Recently while I was working on Nuxt project Prettier was forcing single line formatting for lines that did not reach given limit while I wanted them to stay spread.
